 ...
 * Оно работает - если 2 бита одинаковые, то дает 0
 * если разные - то 1
 *
 * Т.е. применяя XOR к массиву, мы сначала добавляем числа к результату, а если встретиться похоже - исключаем его.
 *
 * Сложность -
 * по времени - O(n)
 * по памяти - O(1)
